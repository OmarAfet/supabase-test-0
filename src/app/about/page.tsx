...
export default function About() {
	return (
		<div className="px-8">
			...
			<p>
				Hello there! Welcome to the About page for the Next.js template crafted by{" "}
				<Link className="link" href="https://github.com/OmarAfet">
					@OmarAfet
				</Link>
				. This template is meticulously designed to provide you with a solid foundation for building modern and responsive web applications using cutting-edge technologies.
			</p>
			...
			<CodeBlock lang="bash" name="console">
				{getCode("GettingStarted.bash")}
			</CodeBlock>
